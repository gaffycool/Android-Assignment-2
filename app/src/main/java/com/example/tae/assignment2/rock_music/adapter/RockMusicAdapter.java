package com.example.tae.assignment2.rock_music.adapter;
...
import com.example.tae.assignment2.rock_music.model.Result;
...
public class RockMusicAdapter extends RecyclerView.Adapter<RockMusicAdapter.MyViewHolder> {
    ...
    private Consumer<RockMusic> consumer;

    public RockMusicAdapter(Context applicationContext, Consumer<RockMusic> consumer, List<Result> results, int row) {
